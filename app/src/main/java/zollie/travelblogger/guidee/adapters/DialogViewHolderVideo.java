...
public class DialogViewHolderVideo extends RecyclerView.ViewHolder{
    ...
    public DialogViewHolderVideo(Context activityContext, View itemView){
        super(itemView);

        this.mContext = activityContext;
        mVideo = (FrameLayout) itemView.findViewById(R.id.mDialogVideo);
        mThumbnail = (YouTubeThumbnailView) itemView.findViewById(R.id.mDialogThumbnail);
        mCarousel = (FrameLayout) itemView.findViewById(R.id.mDialogVideoCard);
    }
}